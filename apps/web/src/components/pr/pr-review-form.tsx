				...
				>
					...
					<div className="flex items-center justify-end gap-2 px-3 py-2.5 border-t border-border">
						<button
							...
							className="px-3 py-1.5 text-[11px] font-mono uppercase tracking-wider border border-border rounded-sm text-muted-foreground hover:text-foreground hover:bg-muted/60 dark:hover:bg-white/3 transition-colors cursor-pointer"
						>
							Cancel
						</button>
						<button
